...
class Story {
  ...
  final DateTime createdAt; // Add audioUrl field
  ...
  Story({
    ...
    required this.name,
    this.audioUrl,
    required this.createdAt, // Initialize audioUrl with null
  });
      ...
      if (user != null) {
        ...
        final story = Story(
          ...
          createdAt: DateTime.now()
              .toUtc(), // Initialize audioUrl with an empty string
        );
        ...
        try {
          ...
          await FirebaseFirestore.instance.collection('stories').add({
            ...
            'audioUrl': audioUrl,
            'createdAt': DateTime.now()
                .toUtc(), // Include audioUrl in Firestore document
          });
              ...
              children: [
                TextField(
                  ...
                  onChanged: (text) {
                    setState(() {
                      _storyEntered =
                          text.isNotEmpty; // Track if story is entered
                    });
                  },
                ),
                SizedBox(height: 20),
