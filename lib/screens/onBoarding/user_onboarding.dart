...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  int maxDisplayedGenres = 24; // Set the maximum number of displayed genres
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Wrap(
              spacing: 8.0, // Adjust the horizontal spacing as needed
              runSpacing: 8.0, // Adjust the vertical spacing as needed
            ...
            ElevatedButton(
              onPressed: () {
                setPref();
                // Save user preferences and navigate to the next screen
                // For simplicity, printing the preferences in this example
                print('User Preferences: $selectedGenres');
              },
              child: Text('Continue'),
            ),
          ],
